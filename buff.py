...
def dota2(headers, cookies):
    time_start = time.time()
    # 标准url_steam:https://steamcommunity.com/market/priceoverview/?country=CN&currency=23&appid=570&market_hash_name=Arena%20Champion%20Shield
    # steam appid=570 为 DOTA2
    ...
    for i in range(craw_page):
        ...
        # 标准url_buff:https://buff.163.com/api/market/goods?game=dota2&page_num=1&min_price=60&max_price=300
    ...
    items_information.to_csv("dota2.csv")
    time_end = time.time()
...
if __name__ == "__main__":
    ...
    cost_time_dota2 = dota2(headers, cookies)
    cost_time_csgo = csgo(headers, cookies)
